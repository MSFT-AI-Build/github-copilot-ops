...
> GitHub Copilot 기반 엔터프라이즈 운영 워크숍 — 구성부터 거버넌스, 관측 가능성, 보안, 비용 관리까지
...
본 워크숍은 **GitHub Copilot을 엔터프라이즈 환경에서 안전하고 효과적으로 운영**하기 위한 실무 중심 가이드입니다. GitHub Copilot의 도입 계획 수립부터 GitHub Enterprise 기반의 거버넌스 체계 구성, 관측 가능성 확보, 보안 운영, 비용 관리까지 **엔터프라이즈 Copilot 운영의 전체 라이프사이클**을 다룹니다.
...
│         ▼                    ▼                                   │
│  ┌──────────────┐  ┌──────────────────────────────────────────┐ │
│  │   Governance  │  │         Copilot Services                 │ │
│  │   Policies    │  │  ┌─────────┐ ┌──────────┐ ┌──────────┐ │ │
│  │              │  │  │ Code    │ │ Chat     │ │ PR       │ │ │
│  │  • Content   │  │  │Complete │ │          │ │ Summary  │ │ │
│  │    Exclusion  │  │  └─────────┘ └──────────┘ └──────────┘ │ │
│  │  • IP Indem. │  │  ┌─────────┐ ┌──────────┐ ┌──────────┐ │ │
│  │  • Telemetry │  │  │ Copilot │ │ Code     │ │Knowledge │ │ │
│  │              │  │  │ Agent  │ │ Review   │ │ Bases    │ │ │
│  └──────────────┘  │  └─────────┘ └──────────┘ └──────────┘ │ │
│                    └──────────────────────────────────────────┘ │
│         │                    │                                   │
│         ▼                    ▼                                   │
│  ┌──────────────────────────────────────────────────────────┐   │
│  │              Observability & FinOps Layer                 │   │
│  │  ┌──────────┐  ┌───────────────┐  ┌────────────────────┐│   │
│  │  │ Copilot  │  │ OTEL          │  │ Azure App          ││   │
│  │  │ Metrics  │──│ Collector     │──│ Insights           ││   │
│  │  │ API      │  │               │  │                    ││   │
│  │  └──────────┘  └───────────────┘  └────────────────────┘│   │
│  │  ┌──────────┐  ┌───────────────┐  ┌────────────────────┐│   │
│  │  │ Billing  │  │ Seat Usage    │  │ Cost Allocation    ││   │
...
이 워크숍 자료는 [MIT License](LICENSE)로 제공됩니다.
